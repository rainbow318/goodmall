...
func (x *EmpytCartResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	default:
		offset, err = fastpb.Skip(buf, _type, number)
		if err != nil {
...
func (x *EmpytCartResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	return offset
...
func (x *EmpytCartResp) Size() (n int) {
	if x == nil {
		return n
	}
	return n
...
var fieldIDToName_EmpytCartResp = map[int32]string{}
