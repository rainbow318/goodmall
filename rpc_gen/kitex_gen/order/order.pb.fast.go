...
func (x *PlaceOrderReq) fastReadField6(buf []byte, _type int8) (offset int, err error) {
	x.IsCharged, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}
...
func (x *PlaceOrder2TrueReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_PlaceOrder2TrueReq[number], err)
}

func (x *PlaceOrder2TrueReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.OrderId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *PlaceOrder2TrueResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	default:
		offset, err = fastpb.Skip(buf, _type, number)
		if err != nil {
...
func (x *GetOrderStatusReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetOrderStatusReq[number], err)
}

func (x *GetOrderStatusReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.OrderId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *GetOrderStatusResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetOrderStatusResp[number], err)
}

func (x *GetOrderStatusResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
...
func (x *PlaceOrderReq) fastWriteField6(buf []byte) (offset int) {
	...
	offset += fastpb.WriteUint32(buf[offset:], 6, x.GetIsCharged())
	return offset
}
...
func (x *PlaceOrder2TrueReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *PlaceOrder2TrueReq) fastWriteField1(buf []byte) (offset int) {
	if x.OrderId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetOrderId())
...
func (x *PlaceOrder2TrueResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	return offset
...
func (x *GetOrderStatusReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *GetOrderStatusReq) fastWriteField1(buf []byte) (offset int) {
	if x.OrderId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetOrderId())
...
func (x *GetOrderStatusResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *GetOrderStatusResp) fastWriteField1(buf []byte) (offset int) {
	if !x.Status {
		return offset
	}
...
func (x *PlaceOrderReq) sizeField6() (n int) {
	...
	n += fastpb.SizeUint32(6, x.GetIsCharged())
	return n
}
...
func (x *PlaceOrder2TrueReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *PlaceOrder2TrueReq) sizeField1() (n int) {
	if x.OrderId == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetOrderId())
...
func (x *PlaceOrder2TrueResp) Size() (n int) {
	if x == nil {
		return n
	}
	return n
...
func (x *GetOrderStatusReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *GetOrderStatusReq) sizeField1() (n int) {
	if x.OrderId == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetOrderId())
...
func (x *GetOrderStatusResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *GetOrderStatusResp) sizeField1() (n int) {
	if !x.Status {
		return n
	}
...
var fieldIDToName_PlaceOrder2TrueReq = map[int32]string{
	1: "OrderId",
}

var fieldIDToName_PlaceOrder2TrueResp = map[int32]string{}

var fieldIDToName_GetOrderStatusReq = map[int32]string{
	1: "OrderId",
}

var fieldIDToName_GetOrderStatusResp = map[int32]string{
	1: "Status",
}
