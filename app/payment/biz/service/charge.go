...
import (
	...
	"github.com/suutest/app/payment/biz/model"
	payment "github.com/suutest/rpc_gen/kitex_gen/payment"
)
...
func (s *ChargeService) Run(req *payment.ChargeReq) (resp *payment.ChargeResp, err error) {
	...
	if err != nil {
		return nil, kerrors.NewGRPCBizStatusError(40001, err.Error())
	}
	transactionId, err := uuid.NewRandom() // 校验id随机生成
	if err != nil {
