...
var SearchProductsArgs_Req_DEFAULT *product.SearchProductReq

func (p *SearchProductsArgs) GetReq() *product.SearchProductReq {
	if !p.IsSetReq() {
...
var SearchProductsResult_Success_DEFAULT *product.SearchProductResp
...
func (p *SearchProductsResult) GetSuccess() *product.SearchProductResp {
	if !p.IsSetSuccess() {
