...
type ListProductsReq struct {
	...
	Page          int32  `protobuf:"varint,1,opt,name=page,proto3" json:"page,omitempty"`                                       // 分页的参数
	PageSize      int32  `protobuf:"varint,2,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`               //每页返回多少商品
	CategoriyName string `protobuf:"bytes,3,opt,name=categoriy_name,json=categoriyName,proto3" json:"categoriy_name,omitempty"` // 用分类名称来获得一个商品列表
}
...
func (x *ListProductsReq) GetCategoriyName() string {
	if x != nil {
		return x.CategoriyName
	}
	return ""
}
...
type Product struct {
	...
	Categories  []string `protobuf:"bytes,6,rep,name=categories,proto3" json:"categories,omitempty"` // 商品分类名称（因为一个商品可以会属于多个类，所以用repeated string）
}
...
type GetProductReq struct {
	...
	Id uint32 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // 请求参数为商品id
}
...
var file_product_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x69, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74,
	...
	0x28, 0x05, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x25, 0x0a, 0x0e,
	0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x79, 0x4e,
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x28, 0x0a, 0x10, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x71, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75,
	0x65, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79,
	0x22, 0x3f, 0x0a, 0x11, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2a, 0x0a, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73,
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xbd, 0x02, 0x0a, 0x15,
	...
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x49, 0x0a,
	0x0e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12,
	0x19, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	...
	,
...
var file_product_proto_goTypes = []interface{}{
	...
	(*BatchGetProductsReq)(nil),  // 7: product.BatchGetProductsReq
	(*BatchGetProductsResp)(nil), // 8: product.BatchGetProductsResp
	nil,                          // 9: product.BatchGetProductsResp.ProductsEntry
}
var file_product_proto_depIdxs = []int32{
	...
	1, // 2: product.SearchProductResp.results:type_name -> product.Product
	9, // 3: product.BatchGetProductsResp.products:type_name -> product.BatchGetProductsResp.ProductsEntry
	1, // 4: product.BatchGetProductsResp.ProductsEntry.value:type_name -> product.Product
	...
	5, // 7: product.ProductCatalogService.SearchProducts:input_type -> product.SearchProductReq
	7, // 8: product.ProductCatalogService.BatchGetProducts:input_type -> product.BatchGetProductsReq
	2, // 9: product.ProductCatalogService.ListProducts:output_type -> product.ListProductsResp
	4, // 10: product.ProductCatalogService.GetProduct:output_type -> product.GetProductResp
	6, // 11: product.ProductCatalogService.SearchProducts:output_type -> product.SearchProductResp
	8, // 12: product.ProductCatalogService.BatchGetProducts:output_type -> product.BatchGetProductsResp
