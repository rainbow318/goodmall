...
type CartItem struct {
	...
	ProductId uint32 `protobuf:"varint,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"` // 要加购的产品ID
	Quantity  uint32 `protobuf:"varint,2,opt,name=quantity,proto3" json:"quantity,omitempty"`                    // 要加购的产品数量
}
...
type EmpytCartResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *EmpytCartResp) Reset() {
	*x = EmpytCartResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *EmpytCartResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmpytCartResp) ProtoMessage() {}

func (x *EmpytCartResp) ProtoReflect() protoreflect.Message {
	mi := &file_cart_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EmpytCartResp.ProtoReflect.Descriptor instead.
func (*EmpytCartResp) Descriptor() ([]byte, []int) {
...
var file_cart_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x0f, 0x0a, 0x0d, 0x45, 0x6d, 0x70, 0x79,
	0x74, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x32, 0xa9, 0x01, 0x0a, 0x0b, 0x43, 0x61,
	...
	0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e, 0x45, 0x6d, 0x70, 0x79, 0x74, 0x43, 0x61, 0x72, 0x74, 0x52,
	0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x75, 0x75, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x72, 0x70, 0x63, 0x5f,
...
var file_cart_proto_goTypes = []interface{}{
	...
	(*EmpytCartResp)(nil), // 6: cart.EmpytCartResp
}
var file_cart_proto_depIdxs = []int32{
	...
	6, // 7: cart.CartService.EmptyCart:output_type -> cart.EmpytCartResp
...
type CartService interface {
	...
	EmptyCart(ctx context.Context, req *EmptyCartReq) (res *EmpytCartResp, err error)
}
